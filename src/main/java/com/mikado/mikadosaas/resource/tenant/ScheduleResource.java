...
import com.mikado.mikadosaas.service.tenant.ScheduleService;
import com.mikado.mikadosaas.resource.errors.BadRequestAlertException;
import com.mikado.mikadosaas.service.dto.tenant.ScheduleDTO;
...
/**
 * REST controller for managing {@link com.mikado.mikadosaas.domain.tenant.Schedule}.
 */
@RestController
@RequestMapping("/api")
