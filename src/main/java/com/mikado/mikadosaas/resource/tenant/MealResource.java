...
import com.mikado.mikadosaas.service.tenant.MealService;
import com.mikado.mikadosaas.resource.errors.BadRequestAlertException;
import com.mikado.mikadosaas.service.dto.tenant.MealDTO;
...
/**
 * REST controller for managing {@link com.mikado.mikadosaas.domain.tenant.Meal}.
 */
@RestController
@RequestMapping("/api")
