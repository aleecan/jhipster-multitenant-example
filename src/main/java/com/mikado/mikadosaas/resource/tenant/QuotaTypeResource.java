...
import com.mikado.mikadosaas.service.tenant.QuotaTypeService;
import com.mikado.mikadosaas.resource.errors.BadRequestAlertException;
import com.mikado.mikadosaas.service.dto.tenant.QuotaTypeDTO;
...
/**
 * REST controller for managing {@link com.mikado.mikadosaas.domain.tenant.QuotaType}.
 */
@RestController
@RequestMapping("/api")
