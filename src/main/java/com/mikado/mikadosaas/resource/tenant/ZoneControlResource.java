...
import com.mikado.mikadosaas.service.tenant.ZoneControlService;
import com.mikado.mikadosaas.resource.errors.BadRequestAlertException;
import com.mikado.mikadosaas.service.dto.tenant.ZoneControlDTO;
...
/**
 * REST controller for managing {@link com.mikado.mikadosaas.domain.tenant.ZoneControl}.
 */
@RestController
@RequestMapping("/api")
