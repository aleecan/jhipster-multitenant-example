...
import com.mikado.mikadosaas.service.tenant.ZoneAccessRuleService;
import com.mikado.mikadosaas.resource.errors.BadRequestAlertException;
import com.mikado.mikadosaas.service.dto.tenant.ZoneAccessRuleDTO;
...
/**
 * REST controller for managing {@link com.mikado.mikadosaas.domain.tenant.ZoneAccessRule}.
 */
@RestController
@RequestMapping("/api")
