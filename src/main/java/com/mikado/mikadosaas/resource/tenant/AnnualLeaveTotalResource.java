...
import com.mikado.mikadosaas.service.tenant.AnnualLeaveTotalService;
...
/**
 * REST controller for managing {@link com.mikado.mikadosaas.domain.tenant.AnnualLeaveTotal}.
 */
@RestController
@RequestMapping("/api")
