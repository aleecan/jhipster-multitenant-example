...
/**
 * A DTO for the {@link com.mikado.multitenant.domain.GateAccessRule} entity.
 */
public class GateAccessRuleDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GateAccessRuleDTO)) {
            return false;
        }

        return id != null && id.equals(((GateAccessRuleDTO) o).id);
    }
