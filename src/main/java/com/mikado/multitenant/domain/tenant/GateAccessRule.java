 ...
 */
@Entity
@Table(name = "gate_access_rule")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class GateAccessRule implements Serializable {
    ...
    @NotNull
    @JsonIgnoreProperties(value = "gateAccessRules", allowSetters = true)
    private Gate gate;
    ...
    public GateAccessRule description(String description) {
    ...
    public GateAccessRule accessType(Integer accessType) {
    ...
    public GateAccessRule useTimezoneCalendar(Boolean useTimezoneCalendar) {
    ...
    public GateAccessRule accessResult(Boolean accessResult) {
    ...
    public GateAccessRule accessCount(Integer accessCount) {
    ...
    public GateAccessRule accessTotalCount(Integer accessTotalCount) {
    ...
    public GateAccessRule counterDay(Integer counterDay) {
    ...
    public GateAccessRule counterWeek(Integer counterWeek) {
    ...
    public GateAccessRule counterMonth(Integer counterMonth) {
    ...
    public GateAccessRule counterResetTime(String counterResetTime) {
    ...
    public GateAccessRule messageNo(String messageNo) {
    ...
    public GateAccessRule messageYes(String messageYes) {
    ...
    public GateAccessRule created(Instant created) {
    ...
    public GateAccessRule modified(Instant modified) {
    ...
    public GateAccessRule modifiedUser(String modifiedUser) {
    ...
    public GateAccessRule gate(Gate gate) {
        this.gate = gate;
        return this;
    }
    ...
    public GateAccessRule accessCode(AccessCode accessCode) {
    ...
    public GateAccessRule authorizationGroup(AuthorizationGroup authorizationGroup) {
    ...
    public GateAccessRule timezone(Timezone timezone) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GateAccessRule)) {
            return false;
        }
        return id != null && id.equals(((GateAccessRule) o).id);
    }
