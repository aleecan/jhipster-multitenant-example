...
import com.mikado.multitenant.service.tenant.GateService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.GateDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.Gate}.
 */
@RestController
@RequestMapping("/api")
