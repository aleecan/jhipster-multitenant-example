...
import com.mikado.multitenant.service.tenant.AnnualLeaveGroupDetailsService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.AnnualLeaveGroupDetails}.
 */
@RestController
@RequestMapping("/api")
