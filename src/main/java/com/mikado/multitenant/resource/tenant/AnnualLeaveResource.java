...
import com.mikado.multitenant.service.tenant.AnnualLeaveService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.AnnualLeaveDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.AnnualLeave}.
 */
@RestController
@RequestMapping("/api")
