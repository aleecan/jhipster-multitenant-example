...
import com.mikado.multitenant.service.tenant.EmployeeHistoryService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.EmployeeHistory}.
 */
@RestController
@RequestMapping("/api")
