...
import com.mikado.multitenant.service.tenant.EntryExitTaskService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.EntryExitTaskDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.EntryExitTask}.
 */
@RestController
@RequestMapping("/api")
