...
import com.mikado.multitenant.service.tenant.VwScheduleChangeService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.VwScheduleChange}.
 */
@RestController
@RequestMapping("/api")
