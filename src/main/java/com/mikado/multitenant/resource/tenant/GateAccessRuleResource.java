...
import com.mikado.multitenant.service.tenant.GateAccessRuleService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.GateAccessRuleDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.GateAccessRule}.
 */
@RestController
@RequestMapping("/api")
