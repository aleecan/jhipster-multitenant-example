...
import com.mikado.multitenant.service.tenant.CalendarService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.Calendar}.
 */
@RestController
@RequestMapping("/api")
public class CalendarResource {
    ...
    public ResponseEntity<CalendarDTO> updateCalendar(@Valid @RequestBody CalendarDTO calendarDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, calendarDTO.getId().toString()))
            .body(result);
    }
