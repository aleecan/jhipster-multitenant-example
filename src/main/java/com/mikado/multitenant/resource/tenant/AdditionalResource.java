...
import com.mikado.multitenant.service.tenant.AdditionalService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.AdditionalDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.Additional}.
 */
@RestController
@RequestMapping("/api")
