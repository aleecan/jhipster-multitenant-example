...
import com.mikado.multitenant.service.tenant.ScheduleChangeService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.ScheduleChange}.
 */
@RestController
@RequestMapping("/api")
