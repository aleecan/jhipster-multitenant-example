...
import com.mikado.multitenant.service.tenant.UserPermissionService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.UserPermission}.
 */
@RestController
@RequestMapping("/api")
