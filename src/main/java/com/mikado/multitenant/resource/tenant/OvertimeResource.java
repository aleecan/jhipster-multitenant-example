...
import com.mikado.multitenant.service.tenant.OvertimeService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.OvertimeDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.Overtime}.
 */
@RestController
@RequestMapping("/api")
public class OvertimeResource {
    ...
    public ResponseEntity<OvertimeDTO> updateOvertime(@Valid @RequestBody OvertimeDTO overtimeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, overtimeDTO.getId().toString()))
            .body(result);
    }
