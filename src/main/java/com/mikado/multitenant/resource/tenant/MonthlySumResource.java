...
import com.mikado.multitenant.service.tenant.MonthlySumService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.MonthlySumDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.MonthlySum}.
 */
@RestController
@RequestMapping("/api")
