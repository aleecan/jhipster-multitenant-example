...
import com.mikado.multitenant.service.tenant.RequestLeaveService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.RequestLeaveDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.RequestLeave}.
 */
@RestController
@RequestMapping("/api")
