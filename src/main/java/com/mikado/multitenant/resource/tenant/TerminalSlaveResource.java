...
import com.mikado.multitenant.service.tenant.TerminalSlaveService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.TerminalSlaveDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.TerminalSlave}.
 */
@RestController
@RequestMapping("/api")
