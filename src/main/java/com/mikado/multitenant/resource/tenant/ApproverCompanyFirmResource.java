...
import com.mikado.multitenant.service.tenant.ApproverCompanyFirmService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.ApproverCompanyFirm}.
 */
@RestController
@RequestMapping("/api")
