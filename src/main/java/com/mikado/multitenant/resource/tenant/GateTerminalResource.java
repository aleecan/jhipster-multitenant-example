...
import com.mikado.multitenant.service.tenant.GateTerminalService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.GateTerminalDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.GateTerminal}.
 */
@RestController
@RequestMapping("/api")
