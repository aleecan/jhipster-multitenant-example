...
import com.mikado.multitenant.service.tenant.NormalService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.NormalDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.Normal}.
 */
@RestController
@RequestMapping("/api")
