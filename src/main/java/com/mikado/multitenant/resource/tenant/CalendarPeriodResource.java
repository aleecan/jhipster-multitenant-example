...
import com.mikado.multitenant.service.tenant.CalendarPeriodService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.CalendarPeriodDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.CalendarPeriod}.
 */
@RestController
@RequestMapping("/api")
