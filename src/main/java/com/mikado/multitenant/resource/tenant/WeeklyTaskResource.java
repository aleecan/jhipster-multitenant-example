...
import com.mikado.multitenant.service.tenant.WeeklyTaskService;
import com.mikado.multitenant.resource.errors.BadRequestAlertException;
import com.mikado.multitenant.service.dto.tenant.WeeklyTaskDTO;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.WeeklyTask}.
 */
@RestController
@RequestMapping("/api")
