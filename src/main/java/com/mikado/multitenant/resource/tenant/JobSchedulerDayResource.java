...
import com.mikado.multitenant.service.tenant.JobSchedulerDayService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.JobSchedulerDay}.
 */
@RestController
@RequestMapping("/api")
