...
import com.mikado.multitenant.service.tenant.AnnualLeaveAddsubService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.AnnualLeaveAddsub}.
 */
@RestController
@RequestMapping("/api")
