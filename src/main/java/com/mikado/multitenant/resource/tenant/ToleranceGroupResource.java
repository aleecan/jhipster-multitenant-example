...
import com.mikado.multitenant.service.tenant.ToleranceGroupService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.ToleranceGroup}.
 */
@RestController
@RequestMapping("/api")
