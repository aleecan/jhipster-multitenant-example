...
import com.mikado.multitenant.service.tenant.MailSchedulerDayService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.MailSchedulerDay}.
 */
@RestController
@RequestMapping("/api")
