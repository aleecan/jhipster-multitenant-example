...
import com.mikado.multitenant.service.tenant.VisitorService;
...
/**
 * REST controller for managing {@link com.mikado.multitenant.domain.tenant.Visitor}.
 */
@RestController
@RequestMapping("/api")
public class VisitorResource {
     ...
     */
    @GetMapping("/visitors")
    public ResponseEntity<List<VisitorDTO>> getAllVisitors(Pageable pageable) {
